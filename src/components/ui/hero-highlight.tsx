...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex flex-col py-[20px] w-full items-center justify-center bg-white",
        containerClassName,
      )}
      onMouseMove={handleMouseMove}
    >
      <h2 className="text-center text-2xl md:text-3xl  text-black  mb-8 px-4">
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `ml-[5px] relative inline-block rounded-[4px] bg-gradient-to-r from-indigo-300 to-purple-300 px-1 pb-1 dark:from-indigo-500 dark:to-purple-500`,
        className,
      )}
    >
      {children}
