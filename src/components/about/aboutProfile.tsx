...
export default function AboutProfile() {
  return (
    <div className="flex flex-col md:flex-row max-w-6xl mx-auto px-4 py-10 gap-8">
      {/* Left Image */}
      <div className="flex-shrink-0 w-full md:w-1/3">
        <Image
          src="/fiona.jpg" // Replace with your actual image in public folder
          alt="Fiona Cousins"
          width={500}
          height={500}
      ...
      {/* Right Text Section */}
      <div className="flex flex-col justify-start space-y-4 md:w-2/3">
        <h1 className="text-4xl font-serif font-semibold text-gray-900">Deepak Sadhwani</h1>
...
{/* 
        ...
        <p className="text-gray-700 text-base">
         Zero Build was founded by Deepak Sadhwani, an architect turned building performance specialist, with a deep belief that good design must be backed by good data.
        </p>

        <p className="text-gray-700 text-base">
           After completing his MSc in Sustainable Mega-Buildings with distinction at Welsh School of Architecture, Cardiff University, Deepak’s research was awarded the prestigious CIBSE President’s Prize, recognising his ability to bridge building physics and design thinking. He is the co-author of the CIBSE Building Physics Guide. His work has been recognised through two interdisciplinary design challenge wins, including the TDUK University Design Challenge 2023 and the Southside Net Zero Design Challenge. In both, he played a leading role in building physics, cost and carbon analysis, and interdisciplinary coordination.
