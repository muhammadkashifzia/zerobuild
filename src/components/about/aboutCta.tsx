...
export default function CtaSection() {
  ...
  return (
    <div className=" p-4 md:p-8 max-w-[1024px] mx-auto w-full flex otems-center justify-between flex-wrap">
      <div className="mb-[24px] max-w-[740px] w-[44%]">
        <h2 className="text-black text-[24px] font-semibold mb-[10px]">
          Ready to take the next step?
        </h2>
        <p className="text-black text-[16px] mb-[10px]">
