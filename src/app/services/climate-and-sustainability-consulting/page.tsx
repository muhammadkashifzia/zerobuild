...
const recentProjects = [
  {
    ...
    title: "Designing an iconic museum",
    description: "A new kind of immersive space, fusing architecture and audio."
  },
  {
    image: "/images/project2.jpg",
    title: "Realising the 'Pearl of the Orient'",
    description: "Acoustic consultancy for a landmark waterfront."
  },
  {
    image: "/images/project3.jpg",
    title: "Technical advice for Dubai’s new super slender skyscraper",
    description: "Solving extreme noise challenges at height."
  },
  {
    image: "/images/project4.jpg",
    title: "Concert hall in Munich",
    description: "Delivering world-class acoustics to a new cultural icon."
  }
];
    ...
    <div className="container grid grid-cols-3 px-[16px] gap-[20px] mx-auto py-[80px]">
     <div className="col-span-2">
      ...
      <div className="space-y-6">
        <h1 className="text-3xl md:text-4xl font-semibold">Acoustic Consulting</h1>
        <p className="text-lg text-gray-700">
          Our experience of places is driven by our ears as much as our eyes,
          which is why acoustics is fundamental to any successful building or
          environment.
        </p>
        <p className="text-gray-600">
          We create spaces with a wide range of acoustic environments, whether
          it’s developing low-reverberation studios or mitigating rail noise. We
          apply rigorous scientific thinking to inform, shape and integrate sound
          strategies with architectural vision.
        </p>
      </div>

      {/* Accordion */}
      <div className="">
        <h2 className="text-2xl font-medium my-4">Discover how we can help:</h2>
      ...
      <div className="col-span-1">
       <div className="rounded-[.75rem] border border-[#e0e0e0] p-[2rem]">
         <h3 className="text-[22px] font-semibold mb-2">Get in touch with our team</h3>
        <Link
          href="/contact"
        ...
        >
         <span > Contact</span> <span className="absolute right-[15px]">→</span>
        </Link>
       </div>
      </div>
    </div>
