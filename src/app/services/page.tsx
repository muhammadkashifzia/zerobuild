        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          ...
          <div className="relative">
            <div className="flex justify-end">
               <button
              className=" text-white text-[24px] bg-black flex items-center gap-[2px] py-[4px] px-[8px] mb-[10px] mj-auto rounded-[3px] btn-mdl"
              onClick={() => setModalOpen(false)}
            >
              <X className="hover:btn-mdl-rotate-45"/> Close
            </button>
            </div>
