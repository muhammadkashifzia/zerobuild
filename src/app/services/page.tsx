        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="relative">
            <div className="flex justify-end">
              <button
                className="text-white text-[24px] bg-black flex items-center gap-[2px] py-[4px] px-[8px] mb-[10px] mj-auto rounded-[3px]"
                onClick={() => setModalOpen(false)}
              >
                <X className="hover:rotate-45 transition-transform" /> Close
              </button>
            </div>
            <div className="bg-white rounded-lg max-w-[630px] w-full p-6 max-h-[80vh] overflow-y-auto">
