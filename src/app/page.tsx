...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "ZeroBuild - Accelerating Net Zero Decarbonisation | Home",
    description:
      "Empowering the built environment to achieve Net Zero faster with proprietary analytics and data-driven tools for Whole Life Carbon assessments and energy modelling.",
  ...
  twitter: {
    ...
    description:
      "Empowering architects, engineers, developers, and local authorities to achieve Net Zero faster with data-driven sustainability solutions.",
...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen  antialiased hide-scrollbar relative bg-[#fafafa]">
      <Image
        src="/assets/svg/pattern-svg-revert.svg"
        alt="pattenLeft"
        width={1000}
        height={1000}
        className="absolute top-[65px] left-[0px] w-[890px] h-auto object-cover"
      />
      <Image
        src="/assets/svg/pattern-svg.svg"
        alt="pattenRight"
        width={1000}
        height={1000}
        className="absolute top-[65px] right-[0px] w-[890px] h-auto object-cover"
      />
